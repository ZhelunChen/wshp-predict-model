function acc_errors = accumulated_errors_plus(pv, spt, criteria_series, reset_threshold)
    ...
    for i = 1:length(pv)
        if system_off(i)
            ...
            if current_acc_error + error > 30000
                current_acc_error = 30000;
            elseif current_acc_error + error < -30000
                current_acc_error = -30000;
            else
